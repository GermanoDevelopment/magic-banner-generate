  ...
  return (
    <div className="flex flex-col items-center max-w-4xl mx-auto gap-12 text-center animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out fill-mode-both w-full">
      ...
      <div className="flex flex-col items-center">
        ...
        <h2 className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-white to-slate-400 tracking-tight font-[family-name:var(--font-outfit)] leading-tight mb-4">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-10 w-full mt-4">
        ...
        <div className="w-full max-w-[450px] aspect-square rounded-[2.5rem] overflow-hidden shadow-[0_0_60px_-15px_rgba(124,58,237,0.4)] ring-1 ring-white/10 relative group bg-slate-900 border-4 border-slate-800/80">
         ...
         {/* Lado Direito - Ações */}
        <div className="w-full max-w-[350px] flex flex-col items-start text-left bg-slate-800/50 p-8 rounded-[2rem] border border-slate-700/50">
